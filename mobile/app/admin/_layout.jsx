...
export default function AdminLayout() {
    ...
    const Sidebar = () => (<View style={[
            ...
            <View style={[styles.sidebarHeader, isCollapsed && { paddingHorizontal: 0, alignItems: 'center' }]}>
                {!isCollapsed ? (<View style={styles.headerTop}>
                        <View>
                        ...
                        <TouchableRipple onPress={() => setIsCollapsed(true)} rippleColor="rgba(0,0,0,0.1)" style={[styles.collapseButton, { backgroundColor: theme.colors.surfaceVariant, borderColor: theme.colors.outline }]}>
                            <AlignLeft size={18} color={theme.colors.primary}/>
                        </TouchableRipple>
                    </View>) : (<TouchableRipple onPress={() => setIsCollapsed(false)} rippleColor="rgba(0,0,0,0.1)" style={[styles.collapseButton, { backgroundColor: theme.colors.primary, marginTop: 10, borderColor: 'transparent' }]}>
            ...
            return (<TouchableRipple key={item.name} onPress={() => router.push(item.path)} {...{
                    ...
                    isActive && {
                        ...
                        borderWidth: 1
                            ...
                            <View style={[styles.navItemContent, isCollapsed && { justifyContent: 'center', paddingHorizontal: 0 }]}>
                                <item.icon size={22} color={isActive ? theme.colors.primary : theme.colors.onSurfaceVariant}/>
                        ...
                        isActive && { fontWeight: '900' }
                                ...
                                {isCollapsed && hoveredItem === item.name && (<View style={[styles.customTooltip, { backgroundColor: theme.colors.elevation.level3, borderColor: theme.colors.outline }]}>
        ...
        onMouseLeave: () => setHoveredItem(null),
                    ...
                    <View style={[styles.navItemContent, isCollapsed && { justifyContent: 'center', paddingHorizontal: 0 }]}>
                        ...
                        {isCollapsed && hoveredItem === 'logout' && (<View style={[styles.customTooltip, { backgroundColor: theme.colors.elevation.level3, borderColor: theme.colors.outline }]}>
    ...
    if (isLargeScreen) {
        return (<View style={[styles.webContainer, { backgroundColor: theme.colors.background }]}>
                <Sidebar />
