 ...
 */
export const CustomDropdown = ({ label, value, options, onSelect, multiSelect = false, placeholder = "Select" }) => {
    ...
    return (<View style={styles.container} onLayout={(e) => setLayoutWidth(e.nativeEvent.layout.width)}>
      {!!label && <Text style={styles.externalLabel}>{label}</Text>}
      
      <Menu visible={visible} onDismiss={closeMenu} contentStyle={[
            styles.menuContent,
            {
                backgroundColor: theme.colors.surface,
                borderColor: theme.colors.outline,
                width: layoutWidth,        }]} anchor={<Pressable onPress={openMenu} 
        onKeyDown={(e) => {
                if (!visible) {
            ...
            return (<React.Fragment key={option.value}>
                    ...
                    pressed && { backgroundColor: theme.colors.surfaceVariant }
                            ...
                            <View style={styles.itemContent}>
                                {multiSelect && (<Checkbox status={active ? 'checked' : 'unchecked'} onPress={() => onSelect(option.value)}/>)}
                                {option.icon}
                                <Text style={[
                    styles.itemText,
